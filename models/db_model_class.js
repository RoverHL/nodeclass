...
class UsersModel {
    ...
    _loadFromMongo(query) {
      var query = query || {};
      console.log('query is ',query);
      return this.User.find( query );
    }

    doQuery(username, city) {
      var query = {};
    ...
    getAll() {
        ...
        // just returning the INITIAL PROMISE, no need for a then on this
    ...
    _buildQueryObject(username, city) {
      var query = {};
      if (username != '') query['username'] = username;
      if (city != '') query['city'] = city;
      return query;
